...
@section('pageTitleSingle','    ویرایش نقش ')
@section('content')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 ">
                            ...
                            <div class="input-group ">
                                <input type="text" name="persian_name" class="form-control" placeholder=" " value="{{ $role->persian_name }}">
                            </div>
                            @error('persian_name')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                                    ...
                                    <div class="col-md-3" style="padding: 20px">
                                        ...
                                        @foreach ($permissions as $permission)
                                            <div class="custom-control custom-control-right custom-checkbox custom-control-inline mt-4">
                                                <input type="checkbox" name="permissions[]" class="custom-control-input" id="{{ $permission->name }}" value="{{ $permission->name }}" {{(in_array($permission->id, $permissionsIDs))? 'checked':''}}>
