...
@section('title','  پست های اینستاگرام ')
@section('pageTitle',' فهرست پست های اینستاگرام  ')
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            <h2> فهرست پست های اینستاگرام </h2>
                        </div>
                    </div>
                    <!--end::Card header-->
                    <!--begin::Card body-->
                    <div class="card-body pt-0">
                        ...
                        <div class="fv-row mb-2">
                            <!--begin::Dropzone-->
                            <form method="post" action="{{route("admin.instagram-posts.store")}}"
                        ...
                        <div class="text-muted fs-7">
                            <a href="{{route('admin.instagram-posts.list')}}" id="kt_ecommerce_add_category_submit"
                ...
                <div class="card" data-select2-id="select2-data-131-rhmf">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1"> فهرست پست های اینستاگرام </span>
                        </h3>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                    ...
                                    <tr class="min-w-125px sorting">
                                        ...
                                        <th class="min-w-125px sorting" rowspan="1" colspan="1"
                                            style="width: 162.9px;" aria-label="Actions">نوع پست
                                        </th>
                                        <th class="min-w-125px sorting" rowspan="1" colspan="1"
                                            ...
                                            <tr class="odd">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        @if($file->type == \App\Constants\Constant::VIDEO)
                                                            <img src="{{asset('admin-assets/media/avatars/video.png')}}"
                                                                 style="width:50px "/>
                                                            <a href="{{asset(\App\Constants\Constant::INSTAGRAM_POST_PATH.$file->name)}}"
                                                            ...
                                                            <div
                                                                ...
                                                                <a href="#">
                                                                    <div class="symbol-label">
                                                                        ...
                                                                        <img
                                                                            src="{{asset(\App\Constants\Constant::INSTAGRAM_POST_PATH.$file->name)}}"
                                                                            alt="Ana Crown"
                                                                            class="w-100">
                                                                    </div>
                                                                </a>
                                                ...
                                                <td class="">
                                                    ...
                                                    @include('admin.__modules.delete-link',[
                                                          'url' => route('admin.instagram-posts.delete',$file)
                                                      ])
                                            ...
                                            <div class="modal fade" id="edit_{{$file->id}}" tabindex="-1" role="dialog" aria-labelledby="editFileModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <form action="{{route('admin.instagram-posts.update',$file)}}" method="post" enctype="multipart/form-data">
...
@section('scripts')
  ...
  `,
            ...
            removedfile: function(file) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{route('admin.instagram-posts.delete-by-name')}}",
                    data: {
